<div class="container my-4">
        ...
        <div class="list-group mt-5">
            ...
            <a href="<?= BASEURL ?>/tambah_data/input_dpcp" class="list-group-item list-group-item-action <?php if ($activeStep == 'data_terkait_pensiun') echo 'active'; ?>">
                Data Terkait Pensiun
            </a>
            <a href="<?= BASEURL ?>/tambah_data/input_daftarKeluarga" class="list-group-item list-group-item-action <?php if ($activeStep == 'daftar_keluarga') echo 'active'; ?>">
                Daftar Keluarga
            </a>
            <a href="<?= BASEURL ?>/tambah_data/data_riwayatPekerjaan" class="list-group-item list-group-item-action <?php if ($activeStep == 'riwayat_pekerjaan') echo 'active'; ?>">
                Riwayat Pekerjaan
            </a>
        </div>
    </div>