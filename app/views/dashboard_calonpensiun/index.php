...
<div class="container my-4">
    ...
    <div class="list-group mt-5">
        <a href="<?= BASEURL ?>/DPCP/<?= isset($data['cp']['nama']) ?>" class="list-group-item list-group-item-action <?php if ($status == 'DPCPselesai') echo 'active'; ?>">
            Data DPCP
        </a>
        <a href="<?= BASEURL ?>/Data_daftarKeluarga/<?= isset($data['cp']['nama']) ?>" class="list-group-item list-group-item-action <?php if ($status == 'DAKselesai') echo 'active'; ?>">
            Daftar Keluarga
        </a>
        <a href="<?= BASEURL ?>/Data_riwayatPekerjaan/<?= isset($data['cp']['nama']) ?>" class="list-group-item list-group-item-action <?php if ($activeStep == 'riwayat_pekerjaan') echo 'active'; ?>">
            Riwayat Pekerjaan
        </a>
    </div>
